...
class Node:
    def __init__(self, grid, agent_depth, max_depth, node_type, position=None, t=None):
        self.grid = grid
    ...
    def evaluation(self):
        ...
        if self.node_type == "Max":
            ...
            for g in possible_action:
                child_node = Node(g[0], self.agent_depth, self.max_depth, "Min", t=self.t)
            ...
            for i in range(tiles):
                ...
                child_node = Node(new_grid, self.agent_depth, self.max_depth, "Chance", new_position, t=self.t)
                child_score, scn_c = child_node.evaluation()
